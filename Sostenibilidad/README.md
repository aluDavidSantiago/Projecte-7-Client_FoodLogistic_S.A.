...
L’objectiu d’aquest treball és analitzar la **sostenibilitat digital** d’una aplicació web real tenint en compte els tres pilars fonamentals:

*   Impacte ambiental
*   Impacte social (accessibilitat – A11Y)
*   Impacte econòmic

L’anàlisi es basa en eines d’avaluació automàtica, comprovacions manuals i criteris de Green IT.
...
*   La **memòria de sostenibilitat** del projecte.
*   Captures dels resultats de les eines:
    *   Website Carbon Calculator
    *   EcoGrader
    *   Lighthouse (Desktop)
*   Captures de comprovació manual d’accessibilitat:
    *   Navegació amb tecla Tab (focus visible)
*   Fragments de codi rellevants relacionats amb accessibilitat i bones pràctiques.
...
*   Anàlisi del pes total de la pàgina i dels recursos multimèdia.
*   Resultats de:
...
Les comprovacions d’accessibilitat s’han realitzat de manera manual i s’han documentat amb captures de pantalla.
...
Totes les evidències (resultats de les eines, comprovacions d’accessibilitat i fragments de codi) es troben incloses dins aquest repositori en format d’imatge i documentació.
